...
def snapConstrain(driver, driven, delete=1):
	...
	"""
    pointCons = pm.pointConstraint(sourceObj, targetObj, weight=1, offset=(0, 0, 0))
    if delete == 1 or delete == 3:
        pm.delete(pointCons)
    orientCons = pm.orientConstraint(sourceObj, targetObj, weight=1, offset=(0, 0, 0))
...
def skeletonizeProxy():
    ...
    for i in range(len(pm.ls('spine_mid_*_loc'))):
        i=int(i)
